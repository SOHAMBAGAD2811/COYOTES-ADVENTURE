...
export default function IntercomDialogueEnd({ onProceed }: Props) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="relative z-10 flex w-full max-w-4xl flex-col md:flex-row items-center gap-8 border-2 border-[#00ff88]/30 bg-matte-base p-8 shadow-[0_0_20px_rgba(0,255,136,0.15)]">
