...
export default function IntercomDialogue0({ onProceed }: Props) {
  const [text, setText] = useState('');
  const fullText = "WAKE UP, COYOTE. THE SYNTHESIZER IS DOWN. WE HAVE EXACTLY 4 MINUTES BEFORE THE AEGIS CONVOY REACHES OASIS CITY. I NEED YOU TO HACK THEIR RADAR AND SIPHON THEIR WATER RESERVES. DO NOT LET THE CORE OVERHEAT.";
